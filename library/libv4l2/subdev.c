 ...
 * @return 0 on success, or a negative error code on failure.
 */
int subdev_g_frame_interval(int fd, struct v4l2_subdev_frame_interval *frame_internval)
{
    int ret = -1;
 ...
 * @return 0 on success, or a negative error code on failure.
 */
int subdev_s_frame_interval(int fd, struct v4l2_subdev_frame_interval *frame_internval)
{
    int ret = -1;
